jQuery(document).ready(function($) {
    'use strict';
    var this_obj = poultry_farm_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.poultry-farm-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message poultry-farm-plugin-install');
                button.addClass('button-primary poultry-farm-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.poultry-farm-recommended-plugins .poultry-farm-activation-note').css('display','block');
    ...
    $(document).on('click', '.poultry-farm-plugin-activate', function(event) {
