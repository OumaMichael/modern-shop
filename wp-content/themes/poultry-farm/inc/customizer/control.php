 ...
 */
class Poultry_Farm_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'poultry-farm' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'poultry-farm-customize-controls' );
		wp_enqueue_script( 'poultry-farm-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Poultry_Farm_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
