 ...
 * @since 1.0.0
 */
class Poultry_Farm_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'poultry_farm';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'poultry-farm' ), $i ),
...
// Initialize.
$Poultry_Farm_Footer_Widgets = new Poultry_Farm_Footer_Widgets();